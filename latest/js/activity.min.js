...
//活动新增／编辑
activityModule.controller('acteditController', ['$scope', '$state', 'activityService',
	function($scope, $state, service) {
...
//商户管理
activityModule.controller('busilistController', ['$scope', '$state', 'activityService',
	function($scope, $state, service) {
...
//道具管理
activityModule.controller('itemlistController', ['$scope', '$state', 'activityService',
	function($scope, $state, service) {
...
//卡券管理
activityModule.controller('ticketlistController', ['$scope', '$state', 'activityService',
	function($scope, $state, service) {
...
angular.module("modules/activity/templates/activity.edit.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/activity.edit.html",
    "<div class=\"account-module ng-scope\"><div class=\"page-header\"><h1>创建活动</h1></div><div class=\"filter clearfix\"><div class=\"row\"><div class=\"col-sm-11\"><div class=\"form-inline\"><ul class=\"se-list cjhdlist\"><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动名称：</label><div class=\"col-sm-10\"><input type=\"text\" ng-model=\"name\" class=\"form-control mc-text-width\" value=\"请输入活动名称\"></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动时间：</label><div class=\"col-sm-10\"><input type=\"text\" ng-model=\"startAt\" class=\"form-control mc-auto-width\" value=\"\"> --<input type=\"text\" ng-model=\"endAt\" class=\"form-control mc-auto-width\" value=\"请选择结束时间\"></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动banner：</label><div class=\"col-sm-10\"><button type=\"button\" class=\"btn btn-default\">+添加活动banner</button></div><input type=\"hidden\" ng-model=\"logoUrl\"></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动介绍：</label><div class=\"col-sm-10\"><textarea class=\"form-control mc-auto-width\" ng-model=\"description\" rows=\"5\" cols=\"80\">请输入活动介绍，如活动规则</textarea></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动声明：</label><div class=\"col-sm-10\"><textarea class=\"form-control mc-auto-width\" ng-model=\"declareTo\" rows=\"5\" cols=\"80\">请输入活动声明</textarea></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>抽奖次数设置：</label><div class=\"col-sm-10\"><i>用户</i><select class=\"form-control mc-auto-width\" ng-model=\"basicPrizeDrawType\"><option value=\"0\" ng-selected=\"true\">每天</option><option value=\"1\">共</option></select><i>可抽奖</i> <input ng-model=\"basicPrizeDrawTime\" class=\"form-control mc-auto-width\">次</div></li><li><label class=\"text-normal text-nowrap col-lg-2\">额外抽奖次数设置：</label><div class=\"col-sm-10\"><p>当用户满足下列条件可设置增加抽奖次数</p><div class=\"clearfix\"><p><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请选择开始时间\"> --<input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请选择结束时间\"></p><p><select ng-model=\"extraPrizeDrawTime\" class=\"form-control mc-auto-width\"><option value=\"\" ng-selected=\"selected\">请选择条件</option><option>每投资满</option><option>累计投资金额满</option><option>单笔投资金额满</option></select><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入投资金额\">元 <input ng-model=\"extraPrizeDrawTime\" class=\"form-control mc-auto-width\">次</p></div></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动奖励及规则：</label><div class=\"col-sm-10\"><p><button type=\"button\" class=\"btn btn-default\">+添加活动奖品及抽奖规则</button></p><table class=\"table table-hover\"><thead><tr><th>奖品名称</th><th width=\"25%\">抽奖条件</th><th>奖品数量</th><th>中奖概率</th><th>奖品投放日期</th><th width=\"20%\">中奖文案</th><th class=\"text-right\">操作</th></tr></thead><tbody><tr class=\"ng-scope\" ng-repeat=\"item in awardList\"><td class=\"ng-binding\">10元投资券</td><td class=\"ng-binding\">实名认证用户</td><td class=\"ng-binding\">--</td><td class=\"ng-binding\">20%</td><td class=\"ng-binding\">2014-11-26</td><td class=\"ng-binding\"></td><td class=\"text-right\"><a href=\"javascript:\">编辑</a> <i class=\"text-divider\">|</i> <a href=\"javascript:\">删除</a></td></tr></tbody></table></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"></label><div class=\"col-sm-10\"><button class=\"btn btn-primary ml10\" type=\"submit\"><i class=\"fa fa-search\"></i> 预览网页</button> <button class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 完成</button> <button class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 返回</button></div></li><li><label class=\"text-normal text-nowrap col-sm-2\">活动奖励及规则：</label><div class=\"col-sm-10\"><table class=\"table table-hover\"><thead><tr><th>奖品名称</th><th width=\"25%\">抽奖条件</th><th>奖品数量</th><th>中奖概率</th><th width=\"20%\">中奖文案</th><th class=\"text-right\">奖品投放日期</th></tr></thead><tbody><tr class=\"ng-scope\"><td class=\"ng-binding\">10元投资券</td><td class=\"ng-binding\">实名认证用户</td><td class=\"ng-binding\">--</td><td class=\"ng-binding\">20%</td><td class=\"ng-binding\"></td><td class=\"text-right\">2014-11-26</td></tr><tr class=\"ng-scope\"><td class=\"ng-binding\">iPhone6</td><td class=\"ng-binding\">2014/12/1-2014/12/30，累计投资金额满50000元</td><td class=\"ng-binding\">500</td><td class=\"ng-binding\">--</td><td class=\"ng-binding\"></td><td class=\"text-right\">2014-11-26</td></tr></tbody></table></div></li><li><label class=\"text-normal text-nowrap col-sm-2\">活动运营数据：</label><div class=\"col-sm-10\"><table class=\"table table-hover yysjtab\"><thead><tr><th>日期</th><th>累计参加人数</th><th>累计中奖人数</th><th>累计新增注册用户数</th><th>累计新增实名认证数</th><th>累计注册并投资人数</th><th>累计首投人数</th><th>当日新注册用户数</th><th>当日实名认证人数</th><th>当日注册并投资人数</th><th class=\"text-right\">当日首投人数</th></tr></thead><tbody><tr class=\"ng-scope\"><td class=\"ng-binding\">2014-11-26</td><td class=\"ng-binding\">200</td><td class=\"ng-binding\">20</td><td class=\"ng-binding\">50</td><td class=\"ng-binding\">40</td><td class=\"ng-binding\">60</td><td class=\"ng-binding\">70</td><td class=\"ng-binding\">120</td><td class=\"ng-binding\">89</td><td class=\"ng-binding\">90</td><td class=\"text-right\">88</td></tr></tbody></table></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"></label><div class=\"col-sm-10\"><button class=\"btn btn-primary ml10\" type=\"submit\"><i class=\"fa fa-search\"></i> 导出运营数据</button> <button class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 编辑活动</button> <button class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 返回</button></div></li></ul></div></div></div></div><div class=\"text-right\" ng-show=\"total\"><ul class=\"pagination-sm\" pagination ng-model=\"page\" items-per-page=\"size\" total-items=\"total\" ng-change=\"query()\"></ul></div></div><div class=\"modal fade ng-isolate-scope in\" style=\"z-index: 1050; display: none\"><div class=\"modal-dialog wind_t_pub add_jp\"><div class=\"modal-content\"><div class=\"modal-header ng-scope\"><a class=\"close\">×</a><h4 class=\"modal-title ng-binding\">添加奖品及抽奖规则</h4></div><div class=\"modal-body ng-scope\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>选择奖品：</label><select class=\"form-control mc-auto-width\"><option>请选择奖品</option><option>10元返利券</option><option>10元现金券</option><option>iPhone6</option><option>10元手机充值卡</option><option>七彩云南游</option></select></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>抽奖条件：</label><select class=\"form-control mc-auto-width\"><option>请选抽奖用条件</option><option>注册用户</option><option>实名认证用户</option><option>有投资记录用户</option><option>累计投资金额满</option><option>单笔投资金额满</option></select><input type=\"text\" ng-model=\"id\" class=\"form-control mc-time-width\" value=\"请选择开始时间\"> <span style=\"float:left\">--</span> <input type=\"text\" ng-model=\"id\" class=\"form-control mc-time-width\" value=\"请选择结束时间\"> <input type=\"text\" ng-model=\"id\" class=\"form-control mc-time-width\" value=\"请输入投资金额\"> <span style=\"float:left\">元</span></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>奖品数量：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入奖品数量\"></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>中奖概率：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入中奖概率\"><span style=\"float:left\">%</span></li><li><label class=\"text-normal text-nowrap\">奖品投放日期：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请选择奖品投放日期\"> <span style=\"float:left;font-size:12px\">奖品从投放日期开始，每天平均投放，若不填则从活动上线时刻开始。</span></li><li><label class=\"text-normal text-nowrap\">中奖文案：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-text-width\" value=\"请输入奖文案\"></li></ul></div><div class=\"modal-footer ng-scope\"><button class=\"btn btn-primary\">确定</button> <button class=\"btn btn-default\">取消</button></div></div></div></div>");
}]);
...
angular.module("modules/activity/templates/activity.edit.rule.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/activity.edit.rule.html",
    "<div class=\"modal-header ng-scope\"><a class=\"close\">×</a><h4 class=\"modal-title ng-binding\">添加奖品及抽奖规则</h4></div><div class=\"modal-body ng-scope\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>选择奖品：</label><select class=\"form-control mc-auto-width\"><option>请选择奖品</option><option>10元返利券</option><option>10元现金券</option><option>iPhone6</option><option>10元手机充值卡</option><option>七彩云南游</option></select></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>抽奖条件：</label><select class=\"form-control mc-auto-width\"><option>请选抽奖用条件</option><option>注册用户</option><option>实名认证用户</option><option>有投资记录用户</option><option>累计投资金额满</option><option>单笔投资金额满</option></select><input type=\"text\" ng-model=\"id\" class=\"form-control mc-time-width\" value=\"请选择开始时间\"> <span style=\"float:left\">--</span> <input type=\"text\" ng-model=\"id\" class=\"form-control mc-time-width\" value=\"请选择结束时间\"> <input type=\"text\" ng-model=\"id\" class=\"form-control mc-time-width\" value=\"请输入投资金额\"> <span style=\"float:left\">元</span></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>奖品数量：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入奖品数量\"></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>中奖概率：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入中奖概率\"><span style=\"float:left\">%</span></li><li><label class=\"text-normal text-nowrap\">奖品投放日期：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请选择奖品投放日期\"> <span style=\"float:left;font-size:12px\">奖品从投放日期开始，每天平均投放，若不填则从活动上线时刻开始。</span></li><li><label class=\"text-normal text-nowrap\">中奖文案：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-text-width\" value=\"请输入奖文案\"></li></ul></div><div class=\"modal-footer ng-scope\"><button class=\"btn btn-primary\">确定</button> <button class=\"btn btn-default\">取消</button></div>");
}]);
...
angular.module("modules/activity/templates/activity.list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/activity.list.html",
    "<div class=\"account-module ng-scope\"><div class=\"page-header\"><h1>活动列表</h1></div><div class=\"filter clearfix\"><div class=\"row\"><div class=\"col-sm-11\"><div class=\"form-inline\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\">活动名称：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入活动名称\"></li><li><button class=\"btn btn-primary ml10\" type=\"submit\"><i class=\"fa fa-search\"></i> 查找</button> <a href=\"cjhd.html\"><button ui-sref=\"activity.actedit({id:-1})\" class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 创建活动</button></a></li></ul></div></div></div></div><table class=\"table table-hover\"><thead><tr><th>序号</th><th>活动名称</th><th>创建时间</th><th>活动开始时间</th><th>活动结束时间</th><th>中奖管理</th><th>状态</th><th class=\"text-right\">操作</th></tr></thead><tbody><tr class=\"ng-scope\" ng-repeat=\"item in list\"><td class=\"ng-binding\">{{$index+1}}</td><td class=\"ng-binding\"><a ui-sref=\"activity.actedit({id:item.id})\">{{item.activityName}}</a></td><td class=\"ng-binding\">{{item.createAt|date 'yyyy-MM-dd HH:mm'}}</td><td class=\"ng-binding\">{{item.startAt|date 'yyyy-MM-dd HH:mm'}}</td><td class=\"ng-binding\">{{item.endAt|date 'yyyy-MM-dd HH:mm'}}</td><td class=\"ng-binding\"><a ui-sref=\"activity.award({id:item.id})\">中奖管理</a></td><td class=\"ng-binding\">{{item.status}}</td><td class=\"text-right\"><a ng-click=\"update(item.id)\">上线</a></td></tr></tbody></table><div class=\"text-right\" ng-show=\"total\"><ul class=\"pagination-sm\" pagination ng-model=\"page\" items-per-page=\"size\" total-items=\"total\" ng-change=\"search(true)\"></ul></div></div>");
}]);

angular.module("modules/activity/templates/award.edit.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/award.edit.html",
    "");
}]);
...
angular.module("modules/activity/templates/award.list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/award.list.html",
    "<div class=\"account-module ng-scope\"><div class=\"page-header\"><h1>中奖管理</h1></div><div class=\"filter clearfix\"><div class=\"row\"><div class=\"col-sm-11\"><div class=\"form-inline\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\">活动名称：</label><select class=\"form-control mc-auto-width\"><option>请选择活动名称</option><option>幸福来敲门</option></select></li><li><label class=\"text-normal text-nowrap\">奖品名称：</label><select class=\"form-control mc-auto-width\"><option>所有奖品</option><option>10元投资券</option><option>10元现金券</option><option>iPhone6</option><option>手机充值卡</option><option>七彩云南游</option></select></li><li><label class=\"text-normal text-nowrap\">奖品发放状态：</label><select class=\"form-control mc-auto-width\"><option>请选择奖品发放状态</option><option>已发放</option><option>未发放</option></select></li><li><label class=\"text-normal text-nowrap\">中奖用户手机号：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入用户手机号\"></li><li><button class=\"btn btn-primary ml10\" type=\"submit\"><i class=\"fa fa-search\"></i> 查找</button> <button class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 发放奖品</button> <button class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 导出EXCEL</button></li></ul></div></div></div></div><table class=\"table table-hover\"><thead><tr><th><input type=\"checkbox\" value=\"\">全选</th><th>序号</th><th>活动名称</th><th>奖品</th><th>中奖用户手机号</th><th>中奖时间</th><th>发放状态</th></tr></thead><tbody><tr class=\"ng-scope\"><td class=\"ng-binding\"><input type=\"checkbox\" value=\"\"></td><td class=\"ng-binding\">1</td><td class=\"ng-binding\">幸福来敲门</td><td class=\"ng-binding\">iPHONE6</td><td class=\"ng-binding\">15710009206</td><td class=\"ng-binding\">2014-11-26 09:28</td><td class=\"ng-binding\">未发放</td></tr><tr class=\"ng-scope\"><td class=\"ng-binding\"><input type=\"checkbox\" value=\"\"></td><td class=\"ng-binding\">2</td><td class=\"ng-binding\">幸福来敲门</td><td class=\"ng-binding\">10元投资券</td><td class=\"ng-binding\">15710009206</td><td class=\"ng-binding\">2014-11-26 09:28</td><td class=\"ng-binding\">已发放</td></tr><tr class=\"ng-scope\"><td class=\"ng-binding\"><input type=\"checkbox\" value=\"\"></td><td class=\"ng-binding\">3</td><td class=\"ng-binding\">幸福来敲门</td><td class=\"ng-binding\">50元投资券</td><td class=\"ng-binding\">15710009206</td><td class=\"ng-binding\">2014-11-26 09:28</td><td class=\"ng-binding\">已发放</td></tr><tr class=\"ng-scope\"><td class=\"ng-binding\"><input type=\"checkbox\" value=\"\"></td><td class=\"ng-binding\">4</td><td class=\"ng-binding\">幸福来敲门</td><td class=\"ng-binding\">100元投资券</td><td class=\"ng-binding\">15710009206</td><td class=\"ng-binding\">2014-11-26 09:28</td><td class=\"ng-binding\">已发放</td></tr></tbody></table><div ng-show=\"total\" class=\"text-right\"><ul class=\"pagination-sm\" pagination ng-model=\"page\" items-per-page=\"size\" total-items=\"total\" ng-change=\"query()\"></ul></div></div>");
}]);
...
angular.module("modules/activity/templates/business.edit.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/business.edit.html",
    "<div class=\"modal-header ng-scope\"><a class=\"close\">×</a><h4 class=\"modal-title ng-binding\">新增商家</h4></div><div class=\"modal-body ng-scope\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>商家名称：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家名称\"></li><li><label class=\"text-normal text-nowrap\">商家网址：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家网址\"></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>商家地址：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家地址\"></li><li><label class=\"text-normal text-nowrap\">商家电话：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家电话\"></li><li><label class=\"text-normal text-nowrap\">商家传真：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家传真\"></li><li><label class=\"text-normal text-nowrap\">商家微博：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家官方微博地址\"></li><li><label class=\"text-normal text-nowrap\">公众号：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家微信公众号\"></li><li><label class=\"text-normal text-nowrap\">邮箱：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-name-width\" value=\"请输入商家邮箱\"></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>商家介绍：</label><textarea cols=\"80\" rows=\"5\" class=\"form-control mc-name-width\">请输入商家介绍</textarea></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>商家logo：</label></li></ul></div><div class=\"modal-footer ng-scope\"><button class=\"btn btn-primary\">确定</button> <button class=\"btn btn-default\">取消</button></div>");
}]);
...
angular.module("modules/activity/templates/business.list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/business.list.html",
    "<div class=\"account-module ng-scope\"><div class=\"page-header\"><h1>商家管理</h1></div><div class=\"filter clearfix\"><div class=\"row\"><div class=\"col-sm-11\"><div class=\"form-inline\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\">关键字：</label><input type=\"text\" ng-model=\"name\" class=\"form-control mc-text-width\" value=\"请输入商家名称\"></li><li><button ng-click=\"search(true)\" class=\"btn btn-primary ml10\" type=\"submit\"><i class=\"fa fa-search\"></i> 查找</button> <button ng-click=\"delete()\" class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 批量删除</button> <button ng-click=\"add()\" class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 新增商家</button></li></ul></div></div></div></div><table class=\"table table-hover\"><thead><tr><th><input type=\"checkbox\" value=\"\">全选</th><th>序号</th><th>商家名称</th><th>logo</th><th width=\"30%\">商家介绍</th><th>操作</th></tr></thead><tbody><tr class=\"ng-scope\" ng-repeat=\"item in list\"><td class=\"ng-binding\"><input type=\"checkbox\" value=\"\"></td><td class=\"ng-binding\">{{$index+1}}</td><td class=\"ng-binding\">{{item.businessName}}</td><td class=\"ng-binding\"><img ng-src=\"item.logo\"></td><td class=\"ng-binding\">{{item.desc}}</td><td class=\"ng-binding\"><a ng-click=\"edit()\">编辑</a> <i class=\"text-divider\">|</i> <a ng-click=\"delete()\">删除</a></td></tr></tbody></table><div ng-show=\"total\" class=\"text-right\"><ul class=\"pagination-sm\" pagination ng-model=\"page\" items-per-page=\"size\" total-items=\"total\" ng-change=\"search()\"></ul></div></div>");
}]);
...
angular.module("modules/activity/templates/item.edit.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/item.edit.html",
    "<div class=\"modal-header ng-scope\"><a class=\"close\">×</a><h4 class=\"modal-title ng-binding\">新增道具</h4></div><div class=\"modal-body ng-scope\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>道具名称：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入道具名称\"></li><li><label class=\"text-normal text-nowrap\">金额：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入道具金额\"></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>选择商家：</label><select class=\"form-control mc-auto-width\"><option>请选商家名称</option><option>商家A</option><option>商家B</option><option>商家C</option><option>商家D</option><option>商家E</option></select></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>道具图片：</label></li></ul></div><div class=\"modal-footer ng-scope\"><button class=\"btn btn-primary\">确定</button> <button class=\"btn btn-default\">取消</button></div>");
}]);
...
angular.module("modules/activity/templates/item.list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/item.list.html",
    "<div class=\"account-module ng-scope\"><div class=\"page-header\"><h1>道具管理</h1></div><div class=\"filter clearfix\"><div class=\"row\"><div class=\"col-sm-11\"><div class=\"form-inline\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\">关键字：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-text-width\" value=\"请输入道具名称或者商家名称\"></li><li><button ng-click=\"search()\" class=\"btn btn-primary ml10\" type=\"submit\"><i class=\"fa fa-search\"></i> 查找</button> <button ng-click=\"delete()\" class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 批量删除</button> <button ng-click=\"add()\" class=\"btn btn-primary ml10\"><i class=\"fa fa-search\"></i> 新增道具</button></li></ul></div></div></div></div><table class=\"table table-hover\"><thead><tr><th><input type=\"checkbox\" value=\"\">全选</th><th>序号</th><th>名称</th><th>金额(元)</th><th width=\"30%\">商家名称</th><th>操作</th></tr></thead><tbody><tr class=\"ng-scope\" ng-repeat=\"item in list\"><td class=\"ng-binding\"><input type=\"checkbox\" value=\"\"></td><td class=\"ng-binding\">{{$index+1}}</td><td class=\"ng-binding\">{{item.name}}}</td><td class=\"ng-binding\">{{item.money}}</td><td class=\"ng-binding\">{{item.businessName}}</td><td class=\"ng-binding\"><a ng-click=\"edit(item)\">编辑</a> <i class=\"text-divider\">|</i> <a ng-click=\"delete(item)\">删除</a></td></tr></tbody></table><div class=\"text-right\" ng-show=\"total\"><ul class=\"pagination-sm\" pagination ng-model=\"page\" items-per-page=\"size\" total-items=\"total\" ng-change=\"search(true)\"></ul></div></div>");
}]);
...
angular.module("modules/activity/templates/ticket.eidt.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/ticket.eidt.html",
    "<div class=\"modal-header ng-scope\"><a class=\"close\">×</a><h4 class=\"modal-title ng-binding\">新增卡券</h4></div><div class=\"modal-body ng-scope\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>卡券类型：</label><label class=\"radio-inline\"><input type=\"radio\" name=\"inlineRadioOptions\" value=\"\">返利券</label><label class=\"radio-inline\"><input type=\"radio\" name=\"inlineRadioOptions\" value=\"\">再来一次券</label></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>卡券名称：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入卡券名称\"></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>金额：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入卡券金额\"> <span class=\"corred\">注：当选择【再来一次券】时，金额非必填</span></li><li><label class=\"text-normal text-nowrap\">返利有效期：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-auto-width\" value=\"请输入返利使用有效期\"><span>天</span><span style=\"font-size:12px;color:#999;margin-left:10px\">若不填，则时间不做限制</span></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>卡券图片：</label></li></ul></div><div class=\"modal-footer ng-scope\"><button class=\"btn btn-primary\">确定</button> <button class=\"btn btn-default\">取消</button></div>");
}]);
...
angular.module("modules/activity/templates/ticket.list.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/ticket.list.html",
    "<div class=\"account-module ng-scope\"><div class=\"page-header\"><h1>卡券管理</h1></div><div class=\"filter clearfix\"><div class=\"row\"><div class=\"col-sm-11\"><div class=\"form-inline\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\">卡券类型：</label><select class=\"form-control\" ng-model=\"type\"><option value=\"0\" ng-selected=\"true\">所有卡券</option><option value=\"1\">返利券</option><option value=\"2\">再来一次券</option></select></li><li><label class=\"text-normal text-nowrap\">关键字：</label><input type=\"text\" ng-model=\"id\" class=\"form-control mc-text-width\" value=\"请输入卡券名称或者金额\"></li><li><button class=\"btn btn-primary ml10\" ng-click=\"search()\" type=\"submit\"><i class=\"fa fa-search\"></i> 查找</button> <button class=\"btn btn-primary ml10\" ng-click=\"delete()\"><i class=\"fa fa-search\"></i> 批量删除</button> <button class=\"btn btn-primary ml10\" ng-click=\"add()\"><i class=\"fa fa-search\"></i> 新增卡券</button></li></ul></div></div></div></div><table class=\"table table-hover\"><thead><tr><th><input type=\"checkbox\" value=\"\">全选</th><th>序号</th><th>卡券类型</th><th width=\"30%\">名称</th><th>金额（元）</th><th>操作</th></tr></thead><tbody><tr class=\"ng-scope\"><td class=\"ng-binding\"><input type=\"checkbox\" value=\"\"></td><td class=\"ng-binding\">{{$index+1}}</td><td class=\"ng-binding\">{{item.type}}</td><td class=\"ng-binding\">{{item.name}}</td><td class=\"ng-binding\">{{item.money}}</td><td class=\"ng-binding\"><a ng-click=\"edit(item)\">编辑</a> <i class=\"text-divider\">|</i> <a ng-click=\"delete(item)\">删除</a></td></tr></tbody></table><div class=\"text-right\" ng-show=\"total\"><ul class=\"pagination-sm\" pagination ng-model=\"page\" items-per-page=\"size\" total-items=\"total\" ng-change=\"search(true)\"></ul></div></div>");
}]);
