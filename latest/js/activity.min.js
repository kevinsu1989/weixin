...
angular.module("modules/activity/templates/activity.edit.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/activity.edit.html",
    "<div class=\"account-module ng-scope\"><div class=\"page-header\"><h1>创建活动</h1></div><div class=\"filter clearfix\"><div class=\"row\"><div class=\"col-sm-11\"><div class=\"form-inline\"><ul class=\"se-list cjhdlist\"><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动名称：</label><div class=\"col-sm-10\"><input ng-disabled=\"!isEdit\" type=\"text\" ng-model=\"activity.name\" class=\"form-control mc-text-width\" placeholder=\"请输入活动名称\"></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动时间：</label><div class=\"col-sm-10\"><input ng-disabled=\"!isEdit||started\" type=\"date\" ng-model=\"activity.startAt\" class=\"form-control mc-auto-width\" placeholder=\"请选择开始时间\"> --<input type=\"date\" ng-model=\"activity.endAt\" class=\"form-control mc-auto-width\" ng-disabled=\"!isEdit\" placeholder=\"请选择结束时间\"></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动banner：</label><div class=\"col-sm-10\"><button ng-if=\"isEdit\" type=\"button\" class=\"btn btn-default\">+添加活动banner</button></div><input type=\"hidden\" ng-model=\"activity.logoUrl\"></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动介绍：</label><div class=\"col-sm-10\"><textarea ng-disabled=\"!isEdit\" class=\"form-control mc-auto-width\" ng-model=\"activity.description\" rows=\"5\" cols=\"80\" placeholder=\"\"></textarea></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动声明：</label><div class=\"col-sm-10\"><textarea ng-disabled=\"!isEdit\" class=\"form-control mc-auto-width\" ng-model=\"activity.declareTo\" rows=\"5\" cols=\"80\"></textarea></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>抽奖次数设置：</label><div class=\"col-sm-10\"><i>用户</i><select ng-disabled=\"!isEdit||started\" class=\"form-control mc-auto-width\" ng-model=\"activity.rule[0].basicPrizeDrawType\"><option value=\"0\" ng-selected=\"true\">每天</option><option value=\"1\">共</option></select><i>可抽奖</i> <input ng-disabled=\"!isEdit||started\" ng-model=\"activity.rule[0].basicPrizeDrawTime\" class=\"form-control mc-auto-width\">次</div></li><li><label class=\"text-normal text-nowrap col-lg-2\">额外抽奖次数设置：</label><div class=\"col-sm-10\"><p>当用户满足下列条件可设置增加抽奖次数</p><div class=\"clearfix\"><p><input ng-disabled=\"!isEdit||started\" type=\"date\" ng-model=\"activity.rule[0].exPrizeDrawStartAt\" class=\"form-control mc-auto-width\" placeholder=\"请选择开始时间\"> --<input ng-disabled=\"!isEdit||started\" type=\"date\" ng-model=\"activity.rule[0].exPrizeDrawEndAt\" class=\"form-control mc-auto-width\" placeholder=\"请选择结束时间\"></p><p><select ng-disabled=\"!isEdit||started\" ng-model=\"activity.rule[0].exPrizeDrawType\" class=\"form-control mc-auto-width\"><option value=\"\" ng-selected=\"selected\">请选择条件</option><option>每投资满</option><option>累计投资金额满</option><option>单笔投资金额满</option></select><input ng-disabled=\"!isEdit||started\" type=\"text\" ng-model=\"activity.rule[0].exPrizeDrawAmount\" class=\"form-control mc-auto-width\" placeholder=\"请输入投资金额\">元 <input ng-disabled=\"!isEdit||started\" ng-model=\"activity.rule[0].extraPrizeDrawTime\" class=\"form-control mc-auto-width\">次</p></div></div></li><li><label class=\"text-normal text-nowrap col-sm-2\"><i class=\"corred\">*</i>活动奖励及规则：</label><div class=\"col-sm-10\"><p><button type=\"button\" ng-if=\"isEdit\" ng-click=\"addAward()\" class=\"btn btn-default\">+添加活动奖品及抽奖规则</button></p><table class=\"table table-hover\" ng-if=\"activity.award.length>0\"><thead><tr><th>奖品名称</th><th width=\"25%\">抽奖条件</th><th>奖品数量</th><th>中奖概率</th><th>奖品投放日期</th><th width=\"20%\">中奖文案</th><th ng-if=\"isEdit\" class=\"text-right\">操作</th></tr></thead><tbody><tr class=\"ng-scope\" ng-repeat=\"item in activity.award\"><td class=\"ng-binding\">{{item.name}}</td><td class=\"ng-binding\">{{item.extraPrizeTypeLimit}}</td><td class=\"ng-binding\">{{item.count}}</td><td class=\"ng-binding\">{{item.probability}}%</td><td class=\"ng-binding\">{{item.releaseAt}}</td><td class=\"ng-binding\">{{item.document}}</td><td class=\"text-right\" ng-if=\"isEdit\"><a ng-click=\"editAward($index)\">编辑</a> <i class=\"text-divider\">|</i> <a ng-click=\"deleteAward($index)\">删除</a></td></tr></tbody></table></div></li><li ng-if=\"isEdit\"><label class=\"text-normal text-nowrap col-sm-2\"></label><div class=\"col-sm-10\"><button class=\"btn btn-primary ml10\" ng-click=\"preview()\" type=\"submit\"><i class=\"fa fa-search\"></i> 预览网页</button> <button class=\"btn btn-primary ml10\" ng-click=\"save()\"><i class=\"fa fa-search\"></i> 完成</button> <button class=\"btn btn-primary ml10\" ng-click=\"quit()\"><i class=\"fa fa-search\"></i> 返回</button></div></li><li ng-if=\"!isEdit\"><label class=\"text-normal text-nowrap col-sm-2\">活动运营数据：</label><div class=\"col-sm-10\"><table class=\"table table-hover yysjtab\"><thead><tr><th>日期</th><th>累计参加人数</th><th>累计中奖人数</th><th>累计新增注册用户数</th><th>累计新增实名认证数</th><th>累计注册并投资人数</th><th>累计首投人数</th><th>当日新注册用户数</th><th>当日实名认证人数</th><th>当日注册并投资人数</th><th class=\"text-right\">当日首投人数</th></tr></thead><tbody><tr class=\"ng-scope\"><td class=\"ng-binding\">2014-11-26</td><td class=\"ng-binding\">200</td><td class=\"ng-binding\">20</td><td class=\"ng-binding\">50</td><td class=\"ng-binding\">40</td><td class=\"ng-binding\">60</td><td class=\"ng-binding\">70</td><td class=\"ng-binding\">120</td><td class=\"ng-binding\">89</td><td class=\"ng-binding\">90</td><td class=\"text-right\">88</td></tr></tbody></table></div></li><li ng-if=\"!isEdit\"><label class=\"text-normal text-nowrap col-sm-2\"></label><div class=\"col-sm-10\"><button class=\"btn btn-primary ml10\" type=\"submit\"><i class=\"fa fa-search\"></i> 导出运营数据</button> <button class=\"btn btn-primary ml10\" ng-click=\"edit()\"><i class=\"fa fa-search\"></i> 编辑活动</button> <button class=\"btn btn-primary ml10\" ng-click=\"back()\"><i class=\"fa fa-search\"></i> 返回</button></div></li></ul></div></div></div></div><div class=\"text-right\" ng-show=\"total\"><ul class=\"pagination-sm\" pagination ng-model=\"page\" items-per-page=\"size\" total-items=\"total\" ng-change=\"query()\"></ul></div></div>");
}]);
...
angular.module("modules/activity/templates/activity.edit.rule.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("modules/activity/templates/activity.edit.rule.html",
    "<div class=\"modal-header ng-scope wind_t_pub add_jp\"><a class=\"close\" ng-click=\"$dismiss()\">×</a><h4 class=\"modal-title ng-binding\">添加奖品及抽奖规则</h4></div><div class=\"modal-body ng-scope wind_t_pub add_jp\"><ul class=\"se-list\"><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>选择奖品：</label><select ng-modal=\"award.sourceID\" class=\"form-control mc-auto-width\"><option>请选择奖品</option><option value=\"1\">10元返利券</option><option value=\"2\">10元现金券</option><option value=\"3\">iPhone6</option><option value=\"4\">10元手机充值卡</option><option value=\"5\">七彩云南游</option></select></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>抽奖条件：</label><select ng-modal=\"award.extraPrizeTypeLimit\" class=\"form-control mc-auto-width\"><option>请选抽奖用条件</option><option value=\"1\">注册用户</option><option value=\"2\">实名认证用户</option><option value=\"3\">有投资记录用户</option><option value=\"4\">累计投资金额满</option><option value=\"5\">单笔投资金额满</option></select><input type=\"date\" ng-model=\"award.count\" class=\"form-control mc-time-width\" value=\"请选择开始时间\"> <span style=\"float:left\">--</span> <input type=\"date\" ng-model=\"award.count\" class=\"form-control mc-time-width\" value=\"请选择结束时间\"> <input ng-if=\"award.extraPrizeTypeLimit==4||award.extraPrizeTypeLimit==5\" type=\"text\" ng-model=\"award.count\" class=\"form-control mc-time-width\" value=\"请输入投资金额\"> <span style=\"float:left\">元</span></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>奖品数量：</label><input type=\"text\" ng-model=\"award.count\" class=\"form-control mc-auto-width\" value=\"请输入奖品数量\"></li><li><label class=\"text-normal text-nowrap\"><i class=\"corred\">*</i>中奖概率：</label><input type=\"text\" ng-model=\"award.probability\" class=\"form-control mc-auto-width\" value=\"请输入中奖概率\"><span style=\"float:left\">%</span></li><li><label class=\"text-normal text-nowrap\">奖品投放日期：</label><input type=\"date\" ng-model=\"award.releaseAt\" class=\"form-control mc-auto-width\" value=\"请选择奖品投放日期\"> <span style=\"float:left;font-size:12px\">奖品从投放日期开始，每天平均投放，若不填则从活动上线时刻开始。</span></li><li><label class=\"text-normal text-nowrap\">中奖文案：</label><input type=\"text\" ng-model=\"award.document\" class=\"form-control mc-text-width\" value=\"请输入中奖文案\"></li></ul></div><div class=\"modal-footer ng-scope wind_t_pub add_jp\"><button class=\"btn btn-primary\" ng-click=\"confirm()\" ng-disabled=\"processing\">确定</button> <button class=\"btn btn-default\" ng-click=\"$dismiss()\">取消</button></div>");
}]);
